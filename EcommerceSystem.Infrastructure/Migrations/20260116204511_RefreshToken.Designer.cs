...
namespace EcommerceSystem.Infrastructure.Migrations
{
    ...
    [Migration("20260116204511_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcommerceSystem.Domain.Models.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EcommerceSystem.Domain.Models.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("EcommerceSystem.Domain.Models.RefreshToken", b =>
                {
                    b.HasOne("EcommerceSystem.Domain.Models.ApplicationUser", "AppUser")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("EcommerceSystem.Domain.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
